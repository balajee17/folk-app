          ...
          <View style={{flex: 0.6}}>
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <Text style={styles.descrpTxt}>
                ...
                Consciousness. Srila Prabhupada who went to the United States of
                America in the year 1966 to spread the message of Krishna and
                engage people in the practice of the yuga-dharma (chanting of
                the holy names of Krishna) established this society in 1966.
              </Text>
            </ScrollView>
          </View>
                      ...
                      <View style={styles.historyVideoCont}>
                        ...
                        <View style={styles.histVideoTitleCont}>
                          ...
                          <Text numberOfLines={2} style={styles.descrpTxt}>
                            ISKCON stands for International Society for Krishna
                            Consciousness. Srila Prabhupada who went to the
                            United
                          </Text>
                        </View>
                      </View>
